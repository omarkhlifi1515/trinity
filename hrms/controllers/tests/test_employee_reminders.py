...
from trinity.controllers.employee_reminders import send_holidays_reminder_in_advancefrom trinity.hr.doctype.hr_settings.hr_settings import set_proceed_with_frequency_changefrom trinity.hr.utils import get_holidays_for_employee
...
class TestEmployeeReminders(IntegrationTestCase):
	...
	def test_birthday_reminders(self):
		...
		from trinity.controllers.employee_reminders import (			get_employees_who_are_born_today,
	...
	def test_work_anniversary_reminders(self):
		from trinity.controllers.employee_reminders import (			get_employees_having_an_event_today,
	...
	def test_advance_holiday_reminders_monthly(self):
		from trinity.controllers.employee_reminders import send_reminders_in_advance_monthly
	...
	def test_advance_holiday_reminders_weekly(self):
		from trinity.controllers.employee_reminders import send_reminders_in_advance_weekly
		setup_hr_settings("Weekly")
