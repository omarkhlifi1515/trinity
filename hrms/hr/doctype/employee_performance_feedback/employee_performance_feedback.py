...
from trinity.hr.doctype.appraisal_cycle.appraisal_cycle import validate_active_appraisal_cyclefrom trinity.hr.utils import validate_active_employeefrom trinity.mixins.appraisal import AppraisalMixin
