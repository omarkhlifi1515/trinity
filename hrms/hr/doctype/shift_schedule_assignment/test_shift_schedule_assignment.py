...
from trinity.hr.doctype.shift_schedule.shift_schedule import get_or_insert_shift_schedulefrom trinity.hr.doctype.shift_type.test_shift_type import setup_shift_type
