...
from trinity.hr.doctype.interview.interview import (	DuplicateInterviewRoundError,
	get_feedback,
	get_skill_wise_average_rating,
	update_job_applicant_status,
)
from trinity.hr.doctype.job_applicant.job_applicant import get_interview_detailsfrom trinity.tests.test_utils import create_job_applicant, get_email_by_subject
...
class TestInterview(IntegrationTestCase):
	...
	def test_notification_for_scheduling(self):
		from trinity.hr.doctype.interview.interview import send_interview_reminder
	...
	def test_notification_for_feedback_submission(self):
		from trinity.hr.doctype.interview.interview import send_daily_feedback_reminder
		setup_reminder_settings()
	...
	def test_skill_wise_average_rating(self):
		from trinity.hr.doctype.interview_feedback.test_interview_feedback import create_interview_feedback
		job_applicant = create_job_applicant()
		interview = create_interview_and_dependencies(job_applicant.name)
