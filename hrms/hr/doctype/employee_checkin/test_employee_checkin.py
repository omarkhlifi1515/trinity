...
from trinity.hr.doctype.attendance.attendance import mark_attendancefrom trinity.hr.doctype.employee_checkin.employee_checkin import (	CheckinRadiusExceededError,
	add_log_based_on_employee_field,
	bulk_fetch_shift,
	calculate_working_hours,
	mark_attendance_and_link_log,
)
from trinity.hr.doctype.leave_type.test_leave_type import create_leave_typefrom trinity.hr.doctype.shift_type.test_shift_type import make_shift_assignment, setup_shift_typefrom trinity.payroll.doctype.salary_slip.test_salary_slip import make_holiday_list, make_leave_application
