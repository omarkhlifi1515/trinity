...
from trinity.hr.doctype.training_event.test_training_event import (	create_training_event,
	create_training_program,
)
from trinity.payroll.doctype.salary_structure.test_salary_structure import make_employee
