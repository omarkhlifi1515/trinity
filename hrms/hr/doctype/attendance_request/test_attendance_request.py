...
from trinity.hr.doctype.attendance.attendance import mark_attendancefrom trinity.hr.doctype.attendance_request.attendance_request import OverlappingAttendanceRequestErrorfrom trinity.hr.doctype.leave_application.test_leave_application import make_allocation_recordfrom trinity.payroll.doctype.salary_slip.test_salary_slip import (	make_holiday_list,
	make_leave_application,
)
from trinity.tests.test_utils import add_date_to_holiday_list, get_first_sundayfrom trinity.tests.utils import HRMSTestSuite
