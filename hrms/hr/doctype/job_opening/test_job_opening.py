...
from trinity.hr.doctype.job_opening.job_opening import close_expired_job_openingsfrom trinity.hr.doctype.staffing_plan.test_staffing_plan import make_company
