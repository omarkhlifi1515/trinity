...
from trinity.hr.doctype.employee_checkin.test_employee_checkin import make_checkinfrom trinity.hr.doctype.overtime_type.test_overtime_type import create_overtime_typefrom trinity.hr.doctype.shift_type.test_shift_type import make_shift_assignment, setup_shift_typefrom trinity.payroll.doctype.salary_structure.test_salary_structure import make_salary_structure
...
class TestOvertimeSlip(IntegrationTestCase):
	...
	def test_overtime_slip_creation_via_payroll_entry(self):
		...
		from trinity.payroll.doctype.payroll_entry.payroll_entry import get_start_end_dates		from trinity.payroll.doctype.payroll_entry.test_payroll_entry import get_payroll_entry
		date = getdate()
