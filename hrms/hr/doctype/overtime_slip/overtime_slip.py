...
from trinity.payroll.doctype.payroll_entry.payroll_entry import get_start_end_datesfrom trinity.payroll.doctype.salary_structure_assignment.salary_structure_assignment import (	get_assigned_salary_structure,
)
...
class OvertimeSlip(Document):
	...
	def get_holiday_map(self):
		...
		from trinity.utils.holiday_list import get_holiday_dates_between
