...
from trinity.hr.doctype.attendance.attendance import (	DuplicateAttendanceError,
	OverlappingShiftAttendanceError,
	get_unmarked_days,
	mark_attendance,
)
from trinity.tests.test_utils import get_first_sunday
...
class TestAttendance(IntegrationTestCase):
	...
	def test_duplicate_attendance_with_shift(self):
		from trinity.hr.doctype.shift_type.test_shift_type import setup_shift_type
		employee = make_employee("test_duplicate_attendance@example.com", company="_Test Company")
		date = nowdate()
	...
	def test_duplicate_attendance_when_created_from_checkins_and_tool(self):
		from trinity.hr.doctype.employee_checkin.test_employee_checkin import make_checkin		from trinity.hr.doctype.shift_type.test_shift_type import setup_shift_type
