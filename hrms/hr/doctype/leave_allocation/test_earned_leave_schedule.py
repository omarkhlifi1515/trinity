...
from trinity.hr.doctype.leave_allocation.test_earned_leaves import make_policy_assignmentfrom trinity.payroll.doctype.salary_slip.test_salary_slip import make_holiday_listfrom trinity.tests.utils import HRMSTestSuite
