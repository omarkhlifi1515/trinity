...
from trinity.hr.doctype.leave_allocation.leave_allocation import (	BackDatedAllocationError,
	OverAllocationError,
)
from trinity.hr.doctype.leave_ledger_entry.leave_ledger_entry import process_expired_allocationfrom trinity.hr.doctype.leave_type.test_leave_type import create_leave_typefrom trinity.tests.utils import HRMSTestSuite
...
class TestLeaveAllocation(HRMSTestSuite):
	...
	def test_carry_forward_leaves_expiry_after_partially_used_leaves(self):
		from trinity.payroll.doctype.salary_slip.test_salary_slip import make_leave_application
		leave_type = create_leave_type(
			leave_type_name="_Test_CF_leave_expiry",
			is_carry_forward=1,
			expire_carry_forwarded_leaves_after_days=90,
	...
	def test_leave_addition_after_submit_with_carry_forward(self):
		from trinity.hr.doctype.leave_application.test_leave_application import (			create_carry_forwarded_allocation,
		)
