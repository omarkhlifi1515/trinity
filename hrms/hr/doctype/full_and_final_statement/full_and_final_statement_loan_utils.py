...
from trinity.payroll.doctype.salary_slip.salary_slip_loan_utils import if_lending_app_installed
if TYPE_CHECKING:
	from trinity.hr.doctype.full_and_final_statement.full_and_final_statement import FullandFinalStatement
