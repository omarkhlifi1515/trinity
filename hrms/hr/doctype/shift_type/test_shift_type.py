...
from trinity.hr.doctype.leave_application.test_leave_application import get_first_sundayfrom trinity.hr.doctype.shift_type.shift_type import update_last_sync_of_checkinfrom trinity.payroll.doctype.salary_slip.test_salary_slip import make_holiday_listfrom trinity.tests.test_utils import add_date_to_holiday_list
...
class TestShiftType(IntegrationTestCase):
	...
	def test_mark_attendance(self):
		from trinity.hr.doctype.employee_checkin.test_employee_checkin import make_checkin
		employee = make_employee("test_employee_checkin@example.com", company="_Test Company")
	...
	def test_skip_auto_attendance_for_duplicate_record(self):
		...
		from trinity.hr.doctype.attendance.attendance import mark_attendance		from trinity.hr.doctype.employee_checkin.test_employee_checkin import make_checkin
		employee = make_employee("test_employee_checkin@example.com", company="_Test Company")
	...
	def test_mark_attendance_for_default_shift_when_shift_assignment_is_not_overlapping(self):
		...
		from trinity.hr.doctype.attendance.attendance import mark_attendance
