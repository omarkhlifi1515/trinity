...
from trinity.hr.doctype.attendance.attendance import mark_attendancefrom trinity.hr.doctype.leave_allocation.test_leave_allocation import create_leave_allocationfrom trinity.hr.doctype.leave_application.leave_application import (	InsufficientLeaveBalanceError,
...
from trinity.hr.doctype.leave_ledger_entry.leave_ledger_entry import expire_allocationfrom trinity.hr.doctype.leave_policy_assignment.leave_policy_assignment import (	create_assignment_for_multiple_employees,
)
from trinity.hr.doctype.leave_type.test_leave_type import create_leave_typefrom trinity.payroll.doctype.salary_slip.test_salary_slip import (	make_holiday_list,
	make_leave_application,
)
from trinity.tests.test_utils import get_first_sundayfrom trinity.tests.utils import HRMSTestSuite
