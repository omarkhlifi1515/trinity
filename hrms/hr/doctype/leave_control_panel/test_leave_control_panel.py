...
from trinity.hr.doctype.leave_allocation.test_leave_allocation import create_leave_allocationfrom trinity.hr.doctype.leave_control_panel.leave_control_panel import LeaveControlPanelfrom trinity.hr.doctype.leave_period.test_leave_period import create_leave_periodfrom trinity.hr.doctype.leave_policy.test_leave_policy import create_leave_policyfrom trinity.tests.test_utils import create_company
