...
from trinity.hr.doctype.employee_onboarding.employee_onboarding import (	IncompleteTaskError,
	make_employee,
)
from trinity.hr.doctype.job_offer.test_job_offer import create_job_offerfrom trinity.payroll.doctype.salary_slip.test_salary_slip import make_holiday_listfrom trinity.tests.test_utils import create_company
