...
from trinity.hr.doctype.job_opening.test_job_opening import get_job_openingfrom trinity.hr.doctype.job_requisition.job_requisition import make_job_opening
