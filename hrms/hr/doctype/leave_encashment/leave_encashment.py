...
from trinity.hr.doctype.leave_application.leave_application import get_leaves_for_periodfrom trinity.hr.doctype.leave_ledger_entry.leave_ledger_entry import create_leave_ledger_entryfrom trinity.hr.utils import set_employee_name, validate_active_employeefrom trinity.payroll.doctype.salary_structure_assignment.salary_structure_assignment import (	get_assigned_salary_structure,
)
