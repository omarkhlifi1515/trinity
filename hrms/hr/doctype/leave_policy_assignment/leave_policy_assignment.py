...
class LeavePolicyAssignment(Document):
	...
	def calculate_leaves_for_passed_period(
		...
		from trinity.hr.utils import get_monthly_earned_leave as get_periodically_earned_leave		from trinity.hr.utils import get_sub_period_start_and_end
	...
	def get_earned_leave_schedule(
		...
		from trinity.hr.utils import (			get_expected_allocation_date_for_period,
...
def is_earned_leave_applicable_for_current_period(date_of_joining, allocate_on_day, earned_leave_frequency):
	from trinity.hr.utils import get_semester_end, get_semester_start
	date = getdate(frappe.flags.current_date) or getdate()
