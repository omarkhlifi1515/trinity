...
from trinity.hr.doctype.leave_allocation.leave_allocation import get_previous_allocationfrom trinity.hr.doctype.leave_application.leave_application import (	get_leave_balance_on,
