...
from trinity.hr.doctype.shift_type.test_shift_type import setup_shift_typefrom trinity.hr.report.shift_attendance.shift_attendance import executefrom trinity.tests.test_utils import create_company
