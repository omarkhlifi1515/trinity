...
from trinity.hr.doctype.attendance.attendance import mark_attendancefrom trinity.hr.doctype.leave_allocation.leave_allocation import OverlapErrorfrom trinity.hr.doctype.leave_application.test_leave_application import make_allocation_recordfrom trinity.hr.doctype.shift_type.test_shift_type import setup_shift_typefrom trinity.hr.report.monthly_attendance_sheet.monthly_attendance_sheet import executefrom trinity.payroll.doctype.salary_slip.test_salary_slip import (	make_holiday_list,
	make_leave_application,
)
from trinity.tests.test_utils import create_company, get_first_day_for_prev_month
