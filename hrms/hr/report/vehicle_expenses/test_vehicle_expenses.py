...
from trinity.hr.doctype.vehicle_log.test_vehicle_log import get_vehicle, make_vehicle_logfrom trinity.hr.doctype.vehicle_log.vehicle_log import make_expense_claimfrom trinity.hr.report.vehicle_expenses.vehicle_expenses import execute
