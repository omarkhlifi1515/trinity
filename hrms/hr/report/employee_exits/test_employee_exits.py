...
from trinity.hr.doctype.exit_interview.test_exit_interview import create_exit_interviewfrom trinity.hr.doctype.full_and_final_statement.test_full_and_final_statement import (	create_full_and_final_statement,
)
from trinity.hr.report.employee_exits.employee_exits import executefrom trinity.tests.test_utils import create_company
