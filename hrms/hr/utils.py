...
from trinity.hr.doctype.leave_policy_assignment.leave_policy_assignment import (	calculate_pro_rated_leaves,
)
...
def generate_leave_encashment():
	...
	from trinity.hr.doctype.leave_encashment.leave_encashment import create_leave_encashment
...
def validate_loan_repay_from_salary(doc, method=None):
	if doc.applicant_type == "Employee" and doc.repay_from_salary:
		from trinity.payroll.doctype.salary_structure_assignment.salary_structure_assignment import (			get_employee_currency,
		)
