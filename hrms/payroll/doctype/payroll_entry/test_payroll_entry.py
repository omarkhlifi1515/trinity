...
from trinity.hr.doctype.employee_advance.employee_advance import (	create_return_through_additional_salary,
)
from trinity.hr.doctype.employee_advance.test_employee_advance import (	make_employee_advance,
	make_journal_entry_for_advance,
)
from trinity.payroll.doctype.payroll_entry.payroll_entry import (	PayrollEntry,
	get_end_date,
	get_start_end_dates,
)
from trinity.payroll.doctype.salary_component.test_salary_component import create_salary_componentfrom trinity.payroll.doctype.salary_slip.salary_slip_loan_utils import if_lending_app_installedfrom trinity.payroll.doctype.salary_slip.test_salary_slip import (	create_account,
...
from trinity.tests.test_utils import create_departmentfrom trinity.utils import get_date_range
...
class TestPayrollEntry(FrappeTestCase):
	...
	def test_employee_benefits_accruals_in_salary_slip(self):
		...
		"""
		from trinity.payroll.doctype.salary_slip.test_salary_slip import (			create_salary_slips_for_payroll_period,
			make_payroll_period,
		)
