...
from trinity.payroll.doctype.salary_slip.salary_slip_loan_utils import if_lending_app_installedfrom trinity.payroll.doctype.salary_withholding.salary_withholding import link_bank_entry_in_salary_withholdings
...
class PayrollEntry(Document):
	...
	def create_overtime_slips(self):
		from trinity.hr.doctype.overtime_slip.overtime_slip import (			create_overtime_slips_for_employees,
	...
	def submit_overtime_slips(self):
		from trinity.hr.doctype.overtime_slip.overtime_slip import (			submit_overtime_slips_for_employees,
		)
	...
	def get_overtime_slip_details(self):
		from trinity.hr.doctype.overtime_slip.overtime_slip import filter_employees_for_overtime_slip_creation
