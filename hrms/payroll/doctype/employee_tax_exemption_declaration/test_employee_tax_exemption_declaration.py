...
from trinity.hr.utils import DuplicateDeclarationError
...
class TestEmployeeTaxExemptionDeclaration(IntegrationTestCase):
	...
	def test_india_hra_exemption_with_multiple_assignments(self):
		from trinity.payroll.doctype.salary_slip.test_salary_slip import create_tax_slab		from trinity.payroll.doctype.salary_structure.test_salary_structure import (			create_salary_structure_assignment,
...
def setup_hra_exemption_prerequisites(frequency, employee=None, from_date=None):
	from trinity.payroll.doctype.salary_slip.test_salary_slip import create_tax_slab	from trinity.payroll.doctype.salary_structure.test_salary_structure import make_salary_structure
