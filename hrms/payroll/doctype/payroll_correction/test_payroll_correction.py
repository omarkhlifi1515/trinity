...
class TestPayrollCorrection(IntegrationTestCase):
	def test_payroll_correction(self):
		from trinity.payroll.doctype.salary_structure.test_salary_structure import make_salary_structure		# test payroll correction, ensure additional salary and employee benefit ledger entries are created\
