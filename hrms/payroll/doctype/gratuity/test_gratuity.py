...
from trinity.hr.doctype.attendance.attendance import mark_attendancefrom trinity.hr.doctype.expense_claim.test_expense_claim import get_payable_accountfrom trinity.payroll.doctype.gratuity.gratuity import get_last_salary_slipfrom trinity.payroll.doctype.salary_slip.test_salary_slip import (	make_deduction_salary_component,
...
def setup_gratuity_rule(name: str) -> dict:
	from trinity.regional.united_arab_emirates.setup import setup
