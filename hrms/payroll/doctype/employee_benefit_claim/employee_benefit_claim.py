...
from trinity.payroll.doctype.payroll_period.payroll_period import get_payroll_periodfrom trinity.payroll.doctype.salary_slip.salary_slip import get_benefits_details_parentfrom trinity.payroll.doctype.salary_structure_assignment.salary_structure_assignment import (	get_assigned_salary_structure,
)
...
class EmployeeBenefitClaim(Document):
	...
	def get_benefit_details(self):
		...
		from trinity.payroll.doctype.employee_benefit_ledger.employee_benefit_ledger import (			get_max_claim_eligible,
		)
