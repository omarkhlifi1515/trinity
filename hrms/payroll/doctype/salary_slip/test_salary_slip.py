...
from trinity.hr.doctype.leave_allocation.test_leave_allocation import create_leave_allocationfrom trinity.hr.doctype.leave_type.test_leave_type import create_leave_typefrom trinity.payroll.doctype.employee_tax_exemption_declaration.test_employee_tax_exemption_declaration import (	create_exemption_category,
	create_payroll_period,
)
from trinity.payroll.doctype.payroll_entry.payroll_entry import get_month_detailsfrom trinity.payroll.doctype.salary_slip.salary_slip import (	HOLIDAYS_BETWEEN_DATES,
	LEAVE_TYPE_MAP,
...
from trinity.payroll.doctype.salary_structure.salary_structure import make_salary_slipfrom trinity.tests.test_utils import get_email_by_subject, get_first_sunday
...
class TestSalarySlip(IntegrationTestCase):
	...
	def test_leave_details(self):
		from trinity.payroll.doctype.salary_structure.test_salary_structure import make_salary_structure
	...
	def test_component_amount_dependent_on_another_payment_days_based_component(self):
		from trinity.payroll.doctype.salary_structure.test_salary_structure import (			create_salary_structure_assignment,
		)
	...
	def test_salary_slip_generation_against_opening_entries_in_ssa(self):
		...
		from trinity.payroll.doctype.payroll_period.payroll_period import get_period_factor		from trinity.payroll.doctype.salary_structure.test_salary_structure import make_salary_structure
	...
	def test_tax_period_for_mid_month_payroll_period(self):
		from trinity.payroll.doctype.payroll_period.payroll_period import get_period_factor
	...
	def test_tax_payable_with_tax_relief_and_marginal_relief_limits(self):
		from trinity.payroll.doctype.salary_structure.test_salary_structure import make_salary_structure		from trinity.regional.india.setup import setup
		setup()
