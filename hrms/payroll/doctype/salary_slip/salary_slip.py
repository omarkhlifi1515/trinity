...
from trinity.hr.utils import validate_active_employeefrom trinity.payroll.doctype.additional_salary.additional_salary import get_additional_salariesfrom trinity.payroll.doctype.employee_benefit_ledger.employee_benefit_ledger import (	create_employee_benefit_ledger_entry,
	delete_employee_benefit_ledger_entry,
)
from trinity.payroll.doctype.payroll_entry.payroll_entry import get_salary_withholdings, get_start_end_datesfrom trinity.payroll.doctype.payroll_period.payroll_period import (	get_payroll_period,
	get_period_factor,
)
from trinity.payroll.doctype.salary_slip.salary_slip_loan_utils import (	cancel_loan_repayment_entry,
	make_loan_repayment_entry,
	process_loan_interest_accrual_and_demand,
	set_loan_repayment,
)
from trinity.payroll.utils import sanitize_expressionfrom trinity.utils.holiday_list import get_holiday_dates_between
# cache keys
...
class SalarySlip(TransactionBase):
	...
	def pull_sal_struct(self):
		from trinity.payroll.doctype.salary_structure.salary_structure import make_salary_slip
		if self.salary_slip_based_on_timesheet:
	...
	def add_leave_balances(self):
		...
		if frappe.db.get_single_value("Payroll Settings", "show_leave_balances_in_salary_slip"):
			from trinity.hr.doctype.leave_application.leave_application import get_leave_details
...
def calculate_tax_by_tax_slab(annual_taxable_earning, tax_slab, eval_globals=None, eval_locals=None):
	from trinity.hr.utils import calculate_tax_with_marginal_relief
	tax_amount = 0
