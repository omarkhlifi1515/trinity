...
const employee = createResource({
	url: "trinity.api.roster.get_values",
	makeParams() {
...
const shiftSchedule = createResource({
	url: "trinity.api.roster.get_schedule_from_assignment",
	makeParams() {
...
const insertShift = createResource({
	url: "trinity.api.roster.insert_shift",
	makeParams() {
		return {
...
const deleteCurrentShift = createResource({
	url: "trinity.api.roster.break_shift",
	makeParams() {
		return {
...
const createShiftAssignmentSchedule = createResource({
	url: "trinity.api.roster.create_shift_schedule_assignment",
	makeParams() {
		return {
			employee: (form.employee as { value: string }).value,
			shift_type: form.shift_type,
...
const deleteShiftScheduleAssignment = createResource({
	url: "trinity.api.roster.delete_shift_schedule_assignment",
	makeParams() {
		return { shift_schedule_assignment: form.shift_schedule_assignment };
	},
	onSuccess: () => {
